...
Casi todo lo de § Reglas de cobertura es revisión de `/keel-validate`, que lee y juzga. Dieciséis reglas están además **mecanizadas** en `keel validate`, y se reparten en dos grupos.
