...
- `audience: both` (un endpoint para ambos públicos) es legítimo, pero es **la excepción**: cualquier cambio para usuarios pasa a ser un cambio para el consumidor servidor. Lo elige el diseñador a sabiendas y su porqué queda en `DESIGN.md`; el análisis de huecos lo lista siempre como riesgo. Ejes de decisión: `.claude/skills/keel-design/references/structural-decisions.md` §3.4 (y §3.8 para la paginación).
