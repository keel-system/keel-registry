...
| [`notifications`](specs/notifications/) | — | — | Emite el correo transaccional de notificación de las aplicaciones consumidoras, a partir de plantillas versionadas que gestiona negocio, aceptando peticiones por evento y por contrato servidor-a-servidor. | `domain`, `use-cases`, `api`, `security`, `messaging`, `persistence`, `mail` | [diseño](docs/notifications/DESIGN.md) · [panel](https://htmlpreview.github.io/?https://raw.githubusercontent.com/keel-system/keel-registry/main/docs/notifications/overview.html) · [API](https://htmlpreview.github.io/?https://raw.githubusercontent.com/keel-system/keel-registry/main/docs/notifications/openapi.html) · [eventos](https://htmlpreview.github.io/?https://raw.githubusercontent.com/keel-system/keel-registry/main/docs/notifications/asyncapi.html) · [integración](docs/notifications/INTEGRATION.md) |
<!-- keel:servicios:end -->
