...
|---|---|---|---|---|---|
| [`catalog`](specs/catalog/) | commerce | — | Gestiona el catálogo comercial —productos con sus imágenes, marcas y categorías—, lo expone filtrable al público de la tienda, lo sirve a otros servidores por contrato y publica sus altas y cambios como eventos. | `domain`, `use-cases`, `api`, `security`, `messaging`, `persistence`, `storage` | [diseño](docs/catalog/DESIGN.md) · [panel](https://htmlpreview.github.io/?https://raw.githubusercontent.com/keel-system/keel-registry/main/docs/catalog/overview.html) · [API](https://htmlpreview.github.io/?https://raw.githubusercontent.com/keel-system/keel-registry/main/docs/catalog/openapi.html) · [eventos](https://htmlpreview.github.io/?https://raw.githubusercontent.com/keel-system/keel-registry/main/docs/catalog/asyncapi.html) · [integración](docs/catalog/INTEGRATION.md) |
| [`notifications`](specs/notifications/) | — | borrador | Correo transaccional multi-aplicación a partir de plantillas versionadas que gestiona negocio, con petición por evento y por contrato servidor-a-servidor, idempotencia por solicitante, lista de supresión por rebotes y quejas, y desenlace publicado como evento. | `domain`, `use-cases`, `api`, `security`, `messaging`, `persistence`, `mail` | [diseño](docs/notifications/DESIGN.md) · [panel](https://htmlpreview.github.io/?https://raw.githubusercontent.com/keel-system/keel-registry/main/docs/notifications/overview.html) · [API](https://htmlpreview.github.io/?https://raw.githubusercontent.com/keel-system/keel-registry/main/docs/notifications/openapi.html) · [eventos](https://htmlpreview.github.io/?https://raw.githubusercontent.com/keel-system/keel-registry/main/docs/notifications/asyncapi.html) · [integración](docs/notifications/INTEGRATION.md) |
| [`user-profile`](specs/user-profile/) | identity | borrador | Perfil de usuario adoptado por aprovisionamiento just-in-time desde un servidor de identidad: un solo dueño de la identidad y un solo dueño del perfil, con el subject del token como única costura. Contacto y N direcciones con división territorial genérica y denormalizada, lápida permanente que impide re-aprovisionar un subject borrado, y superficie servidor-a-servidor separada por scope entre quien necesita contacto y quien necesita dirección de envío. | `domain`, `use-cases`, `api`, `security`, `messaging`, `persistence` | [diseño](docs/user-profile/DESIGN.md) · [panel](https://htmlpreview.github.io/?https://raw.githubusercontent.com/keel-system/keel-registry/main/docs/user-profile/overview.html) · [API](https://htmlpreview.github.io/?https://raw.githubusercontent.com/keel-system/keel-registry/main/docs/user-profile/openapi.html) · [eventos](https://htmlpreview.github.io/?https://raw.githubusercontent.com/keel-system/keel-registry/main/docs/user-profile/asyncapi.html) · [integración](docs/user-profile/INTEGRATION.md) |
<!-- keel:servicios:end -->
